...
tello1_address = ('192.168.0.248', 8889)
tello2_address = ('192.168.0.184', 8889)
tello3_address = ('192.168.0.254', 8889)
tello4_address = ('192.168.0.165', 8889)
...
def send(message, delay):
  ...
  try:
    ...
    sock3.sendto(message.encode(), tello2_address)
    sock4.sendto(message.encode(), tello2_address)
...
def receive():
  ...
  while True:
    ...
    try:
      ...
      response4, ip_address = sock2.recvfrom(128)
...
for i in range(4):
  # Fly forward
  send("forward " + str(box_leg_distance), 2)
  send("back " + str(box_leg_distance),2)
  # Yaw right
